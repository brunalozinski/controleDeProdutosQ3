...
namespace ControleProdutosQ3.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        {
            List<ProdutoModel> produtos = await _produtoRepositorio.BuscaTodos();
        ...
        [HttpPost]
        public async Task<IActionResult> Alterar (ProdutoModel produto, IFormFile?
            imagemCarregada, DateTime dataAlterada)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Criar (ProdutoModel produto, IFormFile?
            imagemCarregada)
        {
            List<ValidationResult> results = new List<ValidationResult>();
            ValidationContext context = new ValidationContext(produto);
